...
const features = [
  ...
  },
  {
    ...
    description: 'Fine-tune text, colors, layout, and branding in our live editor to match your channel perfectly.',
...
const faqs = [
  ...
  },
  {
    ...
    a: 'The free plan includes 5 thumbnails per month with basic styles. Upgrade to Pro for 100/month with all styles and video-to-thumbnail extraction.',
  },
  {
              ...
              >
                ...
                >
                  ...
                  <div className="mb-7">
                    ...
                    {plan.price > 0 && <span className="text-sm text-[var(--fm-text-secondary)]">/mo</span>}
                  </div>
