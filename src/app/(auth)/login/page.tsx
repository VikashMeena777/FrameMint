        ...
        <div className="w-full max-w-[400px]">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            {!isLogin && (
              <div>
                ...
                <div className="relative">
                  <User className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 z-10 text-[var(--fm-text-secondary)]" />
                  <input
                    type="text"
                    value={fullName}
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 z-10 text-[var(--fm-text-secondary)]" />
                <input
                  type="email"
                  value={email}
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 z-10 text-[var(--fm-text-secondary)]" />
                <input
                ...
                <button
                  ...
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 z-10 text-[var(--fm-text-muted)] hover:text-[var(--fm-text-secondary)] transition-colors"
                >
